...
// fetchMovies('https://api.themoviedb.org/3/trending/movie/week?api_key=19f84e11932abbc79e6d83f82d6d1045', '.original__movies', 'poster_path');
...
showMovies = (movies, dom_element, path_type) => {
  ...
  for (let movie of movies.results) {
    ...
    imgEle.setAttribute('data-id', movie.id);
    imgEle.src = `https://image.tmdb.org/t/p/original${movie[path_type]}`
...
function getOriginals() {
  ...
  // let dom_element = document.querySelector('.original__movies');
  // path_types = 'backdrop_path';
